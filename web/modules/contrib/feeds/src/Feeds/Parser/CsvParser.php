...
class CsvParser extends ParserBase implements ParserWithTemplateInterface {
  ...
  public function parse(FeedInterface $feed, FetcherResultInterface $fetcher_result, StateInterface $state) {
    ...
    // Wrap parser in a limit iterator if a positive limit is defined.
    $line_limit = (int) $this->configuration['line_limit'];
    if ($line_limit > 0) {
      $parser = new \LimitIterator($parser, 0, $line_limit);
    }
